<div class="w-2xl p-2">
    <form>
        <div class="m-2 ">
            <input wire:model.live.debounce.300ms="searchText" type="text" class="w-full border-2 rounded-full border-black px-8 py-2 hover:text-blue-600" placeholder="{{ $placeholder }}">
