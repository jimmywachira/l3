<div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
    ...
    <div class="justify-end flex gap-4 mb-4">
        <button wire:click='togglePublished(false)' @class(['text-gray-600 px-4 py-2 hover:text-xl border-2 border-blue-700 hover:text-black'=> $this->showOnlyPublished,
            'text-white bg-blue-600 px-4 py-2 hover:text-xl hover:bg-blue-700' => !$this->showOnlyPublished,
            ])>Show All</button>

        <button wire:click='togglePublished(true)' @class([ 'text-gray-600 px-4 py-2 hover:text-xl border-2 border-blue-700 hover:text-black'=> !$this->showOnlyPublished,
            'text-white bg-blue-600 px-4 py-2 hover:text-xl hover:bg-blue-700' => $this->showOnlyPublished,
            ])>Show Published (
